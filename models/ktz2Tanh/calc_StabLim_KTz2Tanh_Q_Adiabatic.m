function [KSt,TSt,QSt] = calc_StabLim_KTz2Tanh_Q_Adiabatic(par,K_values,T_values,use_complex_ev)
    % par has to define:
    ...
    for i = 1:numel(KSt)
        ...
        QSt{i}                 = clean_data(Qfast,Q_StLim(par.l,par.d,par.xR,xSSt{i},Qfast));
