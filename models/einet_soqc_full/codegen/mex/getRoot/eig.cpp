...
static emlrtRTEInfo db_emlrtRTEI = { 114,/* lineNo */
  9,                                   /* colNo */
  "eig",                               /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\matfun\\eig.m"/* pName */
};

static emlrtRTEInfo eb_emlrtRTEI = { 95,/* lineNo */
  9,                                   /* colNo */
  "eig",                               /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\matfun\\eig.m"/* pName */
};

static emlrtRTEInfo fb_emlrtRTEI = { 80,/* lineNo */
  13,                                  /* colNo */
  "eig",                               /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\matfun\\eig.m"/* pName */
};

static emlrtRTEInfo gb_emlrtRTEI = { 130,/* lineNo */
  13,                                  /* colNo */
  "eig",                               /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\matfun\\eig.m"/* pName */
};

static emlrtRTEInfo hb_emlrtRTEI = { 47,/* lineNo */
  5,                                   /* colNo */
  "xgeev",                             /* fName */
...
static emlrtRTEInfo jb_emlrtRTEI = { 33,/* lineNo */
  5,                                   /* colNo */
  "xgeev",                             /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgeev.m"/* pName */
};
...
void eig(const emlrtStack *sp, const emxArray_creal_T *A, emxArray_creal_T *V)
{
  ...
  if (anyNonFinite(&st, A)) {
    if ((A->size[0] == 1) && (A->size[1] == 1)) {
      i = V->size[0];
      V->size[0] = 1;
      emxEnsureCapacity_creal_T(sp, V, i, &fb_emlrtRTEI);
      V->data[0].re = rtNaN;
      V->data[0].im = 0.0;
    } else {
      i = V->size[0];
    ...
    if ((A->size[0] == 1) && (A->size[1] == 1)) {
      ...
      emxInit_creal_T(sp, &b_A, 2, &kb_emlrtRTEI, true);
      if (p) {
        i = b_A->size[0] * b_A->size[1];
        b_A->size[0] = A->size[0];
        b_A->size[1] = A->size[1];
        emxEnsureCapacity_creal_T(sp, b_A, i, &gb_emlrtRTEI);
        j = A->size[0] * A->size[1];
        for (i = 0; i < j; i++) {
          b_A->data[i] = A->data[i];
        }
        ...
        i = V->size[0];
        V->size[0] = b_A->size[0];
        emxEnsureCapacity_creal_T(&st, V, i, &ib_emlrtRTEI);
        ...
        b_A->size[0] = A->size[0];
        b_A->size[1] = A->size[1];
        emxEnsureCapacity_creal_T(&b_st, b_A, i, &hb_emlrtRTEI);
        j = A->size[0] * A->size[1];
        for (i = 0; i < j; i++) {
          b_A->data[i] = A->data[i];
        }
        ...
        i = V->size[0];
        V->size[0] = A->size[1];
        emxEnsureCapacity_creal_T(&b_st, V, i, &jb_emlrtRTEI);
