function [KSt,TSt,dSt] = calc_StabLim_KTz2Tanh_d_Adiabatic(par,K_values,T_values,use_complex_ev)
    % par has to define:
    ...
    for i = 1:numel(KSt)
        ...
        dSt{i}                 = clean_data(Qfast,delta_StLim(par.l,par.xR,xSSt{i},par.Q,Qfast));
    end
