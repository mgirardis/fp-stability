/*
 * _coder_getRoot_api.cpp
 *
 * Code generation for function '_coder_getRoot_api'
 *
 */
...
void getRoot_api(const mxArray * const prhs[3], int32_T, const mxArray *plhs[1])
{
  emxArray_real_T *p;
  emxArray_creal_T *r;
  real_T k;
  ...
  emxInit_real_T(&st, &p, 2, &lb_emlrtRTEI, true);
  emxInit_creal_T(&st, &r, 2, &lb_emlrtRTEI, true);
...
/* End of code generation (_coder_getRoot_api.cpp) */
