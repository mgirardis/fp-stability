...
static emlrtRTEInfo t_emlrtRTEI = { 32,/* lineNo */
  1,                                   /* colNo */
  "roots",                             /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\roots.m"/* pName */
};
...
static emlrtRTEInfo y_emlrtRTEI = { 103,/* lineNo */
  5,                                   /* colNo */
  "roots",                             /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\roots.m"/* pName */
};

static emlrtRTEInfo ab_emlrtRTEI = { 59,/* lineNo */
  5,                                   /* colNo */
  "roots",                             /* fName */
  "C:\\Program Files\\Polyspace\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\roots.m"/* pName */
};
...
void b_roots(const emlrtStack *sp, const emxArray_real_T *c, emxArray_creal_T *r)
{
  ...
  i = c->size[1] - 1;
  if (i < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(i), &d_emlrtDCI, sp);
  }

  k2 = r->size[0];
  r->size[0] = i;
  emxEnsureCapacity_creal_T(sp, r, k2, &t_emlrtRTEI);
  k2 = c->size[1] - 1;
  if (k2 < 0) {
    emlrtNonNegativeCheckR2012b(static_cast<real_T>(k2), &d_emlrtDCI, sp);
  }
  ...
  if (k1 < k2) {
    emxInit_real_T(sp, &ctmp, 2, &ab_emlrtRTEI, true);
    companDim = k2 - k1;
    i = ctmp->size[0] * ctmp->size[1];
    ctmp->size[0] = c->size[0];
    ctmp->size[1] = c->size[1];
    emxEnsureCapacity_real_T(sp, ctmp, i, &u_emlrtRTEI);
    exitg1 = false;
    ...
    if (companDim < 1) {
      ...
      k2 = r->size[0];
      r->size[0] = i;
      emxEnsureCapacity_creal_T(sp, r, k2, &x_emlrtRTEI);
    } else {
      ...
      emxInit_creal_T(sp, &a, 2, &w_emlrtRTEI, true);
      i = a->size[0] * a->size[1];
      a->size[0] = companDim;
      a->size[1] = companDim;
      ...
      emxInit_creal_T(sp, &eiga, 1, &bb_emlrtRTEI, true);
      st.site = &h_emlrtRSI;
      eig(&st, a, eiga);
      st.site = &g_emlrtRSI;
      emxFree_creal_T(&a);
    ...
    k2 = r->size[0];
    r->size[0] = i;
    emxEnsureCapacity_creal_T(sp, r, k2, &v_emlrtRTEI);
  }
...
void roots(const emlrtStack *sp, const emxArray_real_T *c, emxArray_creal_T *r)
{
  ...
  if (k1 < k2) {
    emxInit_real_T(sp, &ctmp, 1, &ab_emlrtRTEI, true);
    companDim = k2 - k1;
    i = ctmp->size[0];
    ctmp->size[0] = c->size[0];
    emxEnsureCapacity_real_T(sp, ctmp, i, &u_emlrtRTEI);
