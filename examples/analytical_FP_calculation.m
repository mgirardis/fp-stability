...
r = [1,-1,1,-1];
fp = getFixedPoints(par,@fixedPointKTLog,@eigenvalJacobKTLog,{s,r},[],[],[],[],true); % true because y == x in this model
...
s = [1,1,-1,-1]; % this are just helper constants from the theory of the KT logistic map
r = [1,-1,1,-1];
fp = getFixedPoints(par,@fixedPointKTzLog,@eigenvalJacobKTzLog,{s,r},[],[],[],[],true); % true because y == x in this model
